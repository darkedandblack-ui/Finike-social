...
export function ChatBox({
  ...
  return (
    <div className="flex h-full min-h-[400px] flex-col rounded-2xl border border-[var(--border)] bg-[var(--card)] backdrop-blur-xl">
      <div className="border-b border-[var(--border)] px-4 py-3">
        <h3 className="font-semibold text-[var(--foreground)]">{recipientName}</h3>
      </div>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <p
                  className={`mt-1 text-xs ${isOwn ? "text-white/70" : "text-[var(--muted)]"}`}
                >
