...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-[var(--border)] bg-[var(--card-solid)]/90 backdrop-blur-xl lg:hidden">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "text-orange-600" : "text-[var(--muted)]"
              )}
            >
